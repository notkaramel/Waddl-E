...
def test_swingLever():
    ...
    swingLever(dps=dps, delay=delay, angle=90)
...
def test_LeverAndTray():
    ...
    tray_angle = 120
    def retrieve(slot): return rollTray(tray_dps, abs(slot/2), slot*tray_angle)

    lever_dps = 600
    lever_angle = 90
    def swing(angle): return swingLever(lever_dps, 0.3, angle)
